...
int main() {
    ...
    courseVecType target = {"线性代数", "编译原理", "模电", "数电", "汇编", "java", "计组", "数据结构"};
    preVecType pre = {std::vector<std::string>{"高等数学"},
    ...
    courseVecType base = {"高等数学", "C", "金工实习"};
    coursePointVecType base_point = {5, 2.5, 2};

    auto res = interface1(target, pre, target_point, base, base_point);
//    for (auto i : res){
